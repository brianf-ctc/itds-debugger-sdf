    ...
    var LibOrderStatus = {
        ...
        extractLineData: function (ciscoLine, orderInfo) {
            ...
            if (ciscoLine) {
                ...
                lineStatusFields.forEach(function (statusData) {
                    if (statusData && statusData.typeCode) {
                        switch (statusData.typeCode.toUpperCase()) {
                            ...
                            case 'SHIPMENTDATE':
                                lineData.ship_date =
                                    vc2_util.formatToVCDate(LibOrderStatus.getVendorValue(statusData.DateTime[0])) ||
                                    lineData.ship_date;
                                break;
                            case 'LINELEVELHOLD':
                ...
                lineData.order_eta =
                    vc2_util.formatToVCDate(LibOrderStatus.getVendorValue(ciscoLine.PromisedDeliveryDateTime)) ||
                    vc2_util.formatToVCDate(ship_eta) ||
                    lineData.order_eta;
                lineData.deliv_eta = vc2_util.formatToVCDate(delivery_eta) || lineData.deliv_eta;
                // set item values
