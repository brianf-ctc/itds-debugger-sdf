 ...
 * with Catalyst Tech.
 *
 * Module Name: VC Services | Carahsoft API
 * @author brianf@nscatalyst.com
 * @description Vendor connector library for Carahsoft services (token generation, order status, invoices).
 *
 * @NApiVersion 2.x
 * @NModuleScope Public
 *
                    ...
                    (orderInfo.Details || []).forEach(function (orderDetail) {
                        ...
                        (orderDetail.LineItems || []).forEach(function (lineInfo) {
                            ...
                            var isShippedStatus = vc2_util.inArray(
                                ...
                                LibCarasoft.ValidShippedStatus
                            );
