 ...
 * with Catalyst Tech.
 *
 * Module Name: VC Services | Dell API
 *
 * @author brianf@nscatalyst.com
 * @description Vendor connector library for Dell services, including PO status and invoice retrieval.
 *
 * CHANGELOGS
 * Date         Author                Remarks
 * 2026-02-27   brianf                Converted to standard CHANGELOGS format; updated header for compliance
 * 2023-03-14   brianf                Updated dell library
 * 2021-05-25   paolodl               Include line numbers
            ...
            try {
                ...
                arrResponse.purchaseOrderDetails.forEach(function (orderDetail) {
                    ...
                    var OrderData = {
                        ...
                        OrderDate: vc2_util.formatToVCDate(orderDetail.purchaseOrderDate),
                    ...
                    for (var i = 0, j = orderDetail.dellOrders.length; i < j; i++) {
                        ...
                        util.extend(orderItem, {
                            ...
                            order_date: vc2_util.formatToVCDate(orderDetail.purchaseOrderDate) || 'NA',
                            order_eta: vc2_util.formatToVCDate(dellOrder.estimatedShipmentDate) || 'NA',
                            deliv_eta: vc2_util.formatToVCDate(dellOrder.estimatedDeliveryDate) || 'NA',

                            ship_date: vc2_util.formatToVCDate(dellOrder.actualShipmentDate) || 'NA',
                            deliv_date: vc2_util.formatToVCDate(dellOrder.actualDeliveryDate) || 'NA',
                        ...
                        if (dellOrder.productInfo && util.isArray(dellOrder.productInfo)) {
                            ...
                            dellOrder.productInfo.forEach(function (productInfo) {
                                if (!vc2_util.isEmpty(productInfo)) {
                                    if (vc2_util.isEmpty(orderItem.item_num)) {
                                        orderItem.item_num = productInfo.skuNumber;
                                        orderItem.vendorSKU = productInfo.skuNumber;
                                        orderItem.ship_qty += parseFloat(productInfo.itemQuantity);
                                    }
                        ...
                        var isShippedStatus = orderItem.line_status
                            ? vc2_util.inArray(
