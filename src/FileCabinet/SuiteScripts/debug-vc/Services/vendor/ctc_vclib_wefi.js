 ...
 * with Catalyst Tech.
 *
 * Module Name: VC Services | WEFI API
 * @author jjacob
 * @description Vendor connector library for WEFI services and invoice retrieval.
 *
 * @NApiVersion 2.x
 * @NModuleScope Public
 *
...
define(function (require) {
    ...
    WEFI.process = function (option) {
        ...
        try {
            ...
            util.extend(returnValue, {
                HasError: true,
                ErrorMsg: vc2_util.extractError(e)
            });
    ...
    WEFI.getTokenCache = function () {
        var token = vc2_util.getNSCache({ key: 'VC_WEFI_TOKEN' });
