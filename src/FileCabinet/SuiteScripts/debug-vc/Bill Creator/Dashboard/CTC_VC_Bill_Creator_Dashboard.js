 ...
 * with Catalyst Tech.
 *
 * Script Name: CTC VC | Bill Creator Dashboard SL
 * Script ID: customscript_ctc_vc_sl_bc_dashboard
 * @author brianf@nscatalyst.com
 * @description Suitelet that renders the Bill Creator dashboard HTML and populates key summary counts.
 *
 * @NApiVersion 2.x
 * @NModuleScope Public
