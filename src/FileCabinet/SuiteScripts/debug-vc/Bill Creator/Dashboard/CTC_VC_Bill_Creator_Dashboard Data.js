 ...
 * with Catalyst Tech.
 *
 * Script Name: CTC VC | Bill Creator Dashboard Data SL
 * Script ID: customscript_ctc_vc_sl_bc_dashboard_data
 * @author brianf@nscatalyst.com
 * @description Data provider Suitelet for the Bill Creator dashboard (tables and metrics JSON).
 *
 * @NApiVersion 2.x
 * @NModuleScope Public
...
define(['N/log', 'N/search', 'N/format', '../../CTC_VC2_Constants'], function (
    log,
    search,
    format,
    vc2_constant
    ...
    function onRequest(context) {
        ...
        if (context.request.parameters.data == 'mainTable') {
            ...
            if (vc2_constant.GLOBAL.LOCATIONS) {
                columns.push(
                    search.createColumn({
                        name: 'location',
                        join: 'CUSTRECORD_CTC_VC_BILL_LINKED_PO'
