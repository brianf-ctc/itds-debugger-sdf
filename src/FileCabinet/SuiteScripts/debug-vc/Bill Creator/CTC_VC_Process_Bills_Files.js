 ...
 * with Catalyst Tech.
 *
 * Script Name: CTC VC | Process Bill Files MR
 * Script ID: customscript_ctc_vc_process_bills
            ...
            var searchOption = {
                ...
                filters: [
                    ...
                    [
                        ...
                        // THIS IS JUST TO CLOSE THE BILL FILE
                        'OR',
                        [
        ...
        reduce: function (context) {
            ...
            for (i = 0; i < arrBillFilesToProcess.length; i++) {
                ...
                try {
                    ...
                    //// LOAD the bill file
                    var BILLFILE = vc_billprocess.loadBillFile({
                        billFileId: CurrentData.billFileId
                    });
                    var BillFileData = BILLFILE.DATA;
                    ...
                    vc2_util.vcLog({
                        ...
                        message: [
                            'ID: ' + BillFileData.ID,
                            'Invoice No: ' + BILLFILE.JSON.invoice,
                            ...
                            'PO Receivable? ' + JSON.stringify(CurrentData.IsOrderReceivable)
                        ].join(' ')
                    });
                    ...
                    if (ReturnObj.varianceAmount) {
                        UpdateValues[BILLFILE_FLD.VARAMT] = ReturnObj.varianceAmount;
                    }

                    if (ReturnObj.id || ReturnObj.BILL_ID) {
