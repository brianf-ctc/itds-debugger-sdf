 ...
 * with Catalyst Tech.
 *
 * Script Name: CTC VC | Generate IF/IR Restlet Debugger
 * Script ID: customscript_ctc_vc_generate_if_ir_dbg
 *
 * @author brianf@nscatalyst.com
 * @description Debug entry point for generating Item Fulfillment/Receipt from Bill Creator payloads.
 *
 * CHANGELOGS
 * Date         Author                Remarks
        ...
        execute: function (context) {
            ...
            try {
                ...
                ns_util.extend(Current, {
                    poId: currentScript.getParameter('custscript_ctc_vc_genbills_poid'),
                    billFileId: currentScript.getParameter('custscript_ctc_vc_genbills_billfile'),
                    isRecievable: true
