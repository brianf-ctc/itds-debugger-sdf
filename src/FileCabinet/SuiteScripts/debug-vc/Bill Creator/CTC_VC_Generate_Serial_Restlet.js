 ...
 * with Catalyst Tech.
 *
 * Script Name: CTC VC | Generate Serial RL
 * Script ID: customscript_vc_serial_record_restlet
 * @author brianf@nscatalyst.com
 * @description Bill Creator Restlet that creates serial number records for a specific PO line.
 *
 * @NApiVersion 2.x
 * @NModuleScope Public
 * @NScriptType Restlet
