...
define([
    ...
    MAP_REDUCE.getInputData = function () {
        ...
        var paramConfigID = ns_runtime
            .getCurrentScript()
            .getParameter({ name: 'custscript_ctcvc_bc_vendor_sftp' });
    ...
    MAP_REDUCE.map = function (context) {
        ...
        var param = {
            billfile: currentScript.getParameter({ name: 'custscript_ctcvc_bc_vendor_filename' }),
            skipfilecheck: currentScript.getParameter({
                name: 'custscript_ctcvc_bc_skip_filenamecheck'
            }),
            skip90days: currentScript.getParameter({
                name: 'custscript_ctcvc_bc_skip_90days_check'
            })
        };
        ...
        try {
            ...
            for (var ii = 0; ii <= fileList.length; ii++) {
                ...
                context.write(fileList[ii].name, configObj);
                return true;
            }
