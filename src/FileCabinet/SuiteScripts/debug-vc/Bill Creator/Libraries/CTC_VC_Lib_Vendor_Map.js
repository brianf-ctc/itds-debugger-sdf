 ...
 * with Catalyst Tech.
 *
 * Script Name: CTC_VC_Lib_Vendor_Map.js
 * @author brianf@nscatalyst.com
 * @description Maps Bill Creator vendor integrations to specific handler modules (SFTP/API processors).
 *
 * CHANGELOGS
 * Date         Author                Remarks
 * 2026-01-28   brianf                Script header updated to VAR Connect standard
 * 2026-01-27   brianf                Initial Build
 *
 * @NApiVersion 2.x
 * @NModuleScope Public
 */
