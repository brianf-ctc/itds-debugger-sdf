        ...
        parseDate: function (option) {
            ...
            try {
                ...
                if (dateString && dateString.length > 0 && dateString != 'NA') {
                    dateValue = moment(dateString).toDate(); // produces a JS Date object
                }
        ...
        try {
            ...
            for (var i = 0; i < billDataArr.length; i++) {
                ...
                var billFileValues = {
                    ...
                    custrecord_ctc_vc_bill_date: moment(billObj.date).toDate(), // Invoice date as JS Date
