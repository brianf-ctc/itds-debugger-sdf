 ...
 * with Catalyst Tech.
 *
 * Module Name: CTC VC2 | Constants
 * @author brianf@nscatalyst.com
 * @description Central constants and configuration values for VAR Connect 2.x (record IDs, fields, cache keys, etc.).
 *
 * CHANGELOGS
 * Date         Author        Remarks
...
define(function (require) {
    ...
    var VC2_CONSTANT = {
        ...
        APPNAME: {
            ORDER_STATUS: 'VAR Connect | Order Status',
            BILL_CREATE: 'VAR Connect | Bill Create',
            SEND_PO: 'VAR Connect | Send PO'
        },
        CACHE_NAME: [
            'VC_CACHE_KEY',
            IS_DEBUG_MODE ? new Date().getTime() : null,
            '20260316.0345' // YYYYMMDD
        ].join('_'),
        GLOBAL: {
    ...
    VC2_CONSTANT.LICENSE = {
        ...
        PRODUCT_CODE: 2,
        MAX_RETRY: 3,
        KEY: ['LICENSE', VC2_CONSTANT.CACHE_NAME].join('_'),
        CACHE_NAME: VC2_CONSTANT.CACHE_NAME,
    ...
    VC2_CONSTANT.MAPPING = {
        MAIN_CONFIG: {
            ...
            allowNonFFItems: MainCFG.FIELD.ALLOW_NONFF_ITEMS
        },
        BILLCREATE_CONFIG: {
            id: BillCFG.FIELD.ID,
            ...
            useFulfillDate: BillCFG.FIELD.USE_FULFILL_DATE
        },
        VENDOR_CONFIG: {
            ...
            useDelivDate: VendorCFG.FIELD.USE_DELIVDATE,
            ...
            useFulfillDate: VendorCFG.FIELD.USE_FULFILL_DATE
        },
        SENDPOVENDOR_CONFIG: {
    ...
    VC2_CONSTANT.SCRIPT = {
        ...
        ORDERSTATUS_SS: 'customscript_ctc_vc_proc_orderstat',
        ...
        SCRIPT_LOADER_SL: 'customscript_ctc_vc_sl_scriptloader'
    };
    VC2_CONSTANT.DEPLOYMENT = {
        ORDERSTATUS_MR: 'customscript_ctc_script_xml_v2',
        ORDERSTATUS_SS: 'customdeploy_ctc_vc_proc_orderstat',
        ...
        SCRIPT_LOADER_SL: 'customdeploy_ctc_vc_sl_scriptloader'
    };
    ...
    Bill_Creator.Code = {
        MISSING_PO: {
            code: 'MISSING_PO',
            msg: 'Unable to find a PO record that matches this bill.',
